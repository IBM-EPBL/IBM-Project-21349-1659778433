...
conn = ibm_db.connect("DATABASE=bludb;HOSTNAME=125f9f61-9715-46f9-9399-c8177b21803b.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud;PORT=30426;SECURITY=SSL;SSLServerCertificate=Certificate.crt;UID=phz1431;PWD=3gtJ6boYjUjQ1fna",'','')
...
def stats():
    ...
    print(count)'''
    return render_template('stats.html',b=1,b1=0,b2=0,b3=1,b4=0,b5=0,b6=0,b7=0,b8=0)
